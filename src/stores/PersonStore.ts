...
export const personFormSchema = z.object({
	...
	personRegisterNumber: z
		.string()
		.min(11, { message: "Esse campo deve ser preenchido." }),
	personType: z.string(),
	phoneNumber: z.string().optional(),
	email: z.string().optional(),
	stateRegistration: z
		.string()
		.max(14, { message: "Esse campo deve conter no máximo 14 caracteres." })
		.optional(),
	companyName: z
		.string()
		.max(60, { message: "Tamanho máximo de 60 caracteres." })
		.optional(),
	street: z
		.string()
		.max(60, { message: "Esse campo deve conter no máximo 60 caracteres." })
		.optional(),
	addressComplement: z
		.string()
		.max(30, { message: "Esse campo deve conter no máximo 30 caracteres." })
		.optional(),
	number: z
		.string()
		.max(10, { message: "Esse campo deve conter no máximo 10 caracteres." })
		.optional(),
	neighborhood: z
		.string()
		.max(60, { message: "Esse campo deve conter no máximo 60 caracteres." })
